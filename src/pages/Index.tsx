  ...
  return (
    <div className="min-h-screen bg-background dark transition-colors duration-300">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-deep-blue via-midnight-blue to-background">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%2300FF88" fill-opacity="0.05"%3E%3Ccircle cx="30" cy="30" r="2"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] animate-pulse"></div>
